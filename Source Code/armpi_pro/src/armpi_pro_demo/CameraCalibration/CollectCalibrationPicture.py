...
print('Press "space" on keyboard to save image and press "Esc" to exit.')
...
#Calculate the number of the stored images
num = 0
while True:
    ret, frame = cap.read()
    if ret:
        ...
        if key == 32:
            while True:
                ...
                if num not in pictures_list:
                    #The format of image name: current number of images.jpg
