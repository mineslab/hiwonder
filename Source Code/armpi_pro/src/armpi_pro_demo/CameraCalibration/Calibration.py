...
def get_K_D(checkerboard_size, imgsPath, param_save_path):
    #Parameter 1:  The horizontal and vertical interior corners of the chessboard
    #Parameter 2: The path of the image to be calibrated
    #Parameter 3:The path of the saved parameter files after calibration
    ...
    print("intrinsic parameters\t: K=np.array(" + str(K.tolist()) + ")")
