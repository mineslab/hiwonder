...
print('Test distortion calibration and press "Esc" to exit')
...
#Capture area. 1 represents the fully capture.
scale = 1
#Optimize the intrinsic parameters and distortion parameter 
