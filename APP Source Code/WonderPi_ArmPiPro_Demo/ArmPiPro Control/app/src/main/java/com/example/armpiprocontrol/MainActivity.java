...
import com.example.armpiprocontrol.component.HorizontalListView;
import com.example.armpiprocontrol.component.HorizontalListViewAdapter;
import com.example.armpiprocontrol.connect.Scanner;
import com.example.armpiprocontrol.dialog.WifiDeviceInfoDialog;
...
//        intent.setClass(getBaseContext(), Control.class);
