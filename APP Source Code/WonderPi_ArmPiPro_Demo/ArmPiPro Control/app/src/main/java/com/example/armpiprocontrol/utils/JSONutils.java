package com.example.armpiprocontrol.utils;
...
public class JSONutils {
    ...
    public static String puppypi_control_car_move(String topic, String velocity, String direction, String angular_rate) {
