...
import com.example.armpiproface.connect.JWebSocketClient;
import com.example.armpiproface.utils.JSONutils;
 ...
 **/
public class FaceRecognition extends TitleActivity {
    private String url;
    ...
    private String service = "face_detect";
    @Override
