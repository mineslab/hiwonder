...
import com.example.armpiproline.component.HorizontalListView;
import com.example.armpiproline.component.HorizontalListViewAdapter;
import com.example.armpiproline.connect.Scanner;
import com.example.armpiproline.dialog.WifiDeviceInfoDialog;
...
//                intent.setClass(getBaseContext(), LineTracking.class);
